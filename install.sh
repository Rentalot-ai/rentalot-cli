...
#   RENTALOT_CLI_VERSION     - Specific version to install (default: latest)
...
main() {
    ...
    local version="${RENTALOT_CLI_VERSION:-}"
    if [ -z "$version" ]; then
    ...
    local install_dir="${RENTALOT_CLI_INSTALL_DIR:-$DEFAULT_INSTALL_DIR}"
